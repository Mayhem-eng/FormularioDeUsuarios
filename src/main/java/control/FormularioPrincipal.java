...
public class FormularioPrincipal extends javax.swing.JFrame {
    ...
    public FormularioPrincipal() {
        initComponents();
        buttConfirmarMoficacoes.setVisible(false);
    ...
    public void desativarAlteracao(){
    ...
    private void initComponents() {
        ...
        buttConfirmarMoficacoes = new javax.swing.JButton();
        ...
        buttConfirmarMoficacoes.setText("confirmar Mofificações");
        buttConfirmarMoficacoes.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buttConfirmarMoficacoesActionPerformed(evt);
            }
        });
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(94, 94, 94)
                                        .addComponent(buttConfirmarMoficacoes))
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(10, 10, 10)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(buttBack, javax.swing.GroupLayout.DEFAULT_SIZE, 56, Short.MAX_VALUE)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(buttPlay)
    ...
    private void buttBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttBackActionPerformed
        try{
            ...
            // Inativo por razões de simplicidade
    ...
    private void buttPlayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttPlayActionPerformed
        ...
        try{
            ...
            if(result.next()){
                ...
                JOptionPane.showMessageDialog(null,"Ultímo dado alcançado","Mensagem do programa", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void buttRevPlayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttRevPlayActionPerformed
         try{
             ...
             if(result.previous()){
                ...
                JOptionPane.showMessageDialog(null,"Já está no primeiro dado","Mensagem do programa", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void buttCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttCadastrarActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Não há dados a serem adicionado ou o codigo já existe","mensagem do programa", JOptionPane.INFORMATION_MESSAGE);
        }    
    ...
    private void buttAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttAlterarActionPerformed
        ...
        buttConfirmarMoficacoes.setVisible(true);
        try{
            
            String codigoAlter = JOptionPane.showInputDialog("Informe o codigo da tabela a ser alterada: ");
        
            
            executeSQL("select * from dadosUsuarios where codigo = "+ codigoAlter);
            
            txtCodigo.setText(codigoAlter);
            txtCodigo.setEditable(false);
    ...
    private void buttExcuirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttExcuirActionPerformed
       ...
       try{
            ...
            if(resposta == 0){
                String sql = "delete from dadosUsuarios where codigo = " + codigoExcluir;
                ptsm.executeUpdate(sql);
    ...
    private void buttConfirmarMoficacoesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttConfirmarMoficacoesActionPerformed
    ...
    }//GEN-LAST:event_buttConfirmarMoficacoesActionPerformed
    ...
    private javax.swing.JButton buttConfirmarMoficacoes;
